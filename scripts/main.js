;(function (window) {
  ...
  let texts = ['MY DEAR', 'LOOK UP', 'AT THE', 'STARRY SKY', 'ARE YOU', 'LOOKING',  'AT THE', 'SAME STAR', 'WITH ME ?', 'HAPPY', 'BIRTHDAY ', 'DAY', 'MY', 'BEAUTIFUL','GIRL','PANDU','I ','LOVE', 'YOU ❤️','SO','MUCH', 'BANGARAM']
